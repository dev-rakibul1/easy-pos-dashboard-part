...
import { ISupplierSells, IUser } from '@/types'
...
const Purchase: React.FC<SupplierActionsProps> = ({ user }) => {
  ...
  const { data: supplierAndUser } =
    useGetSupplierSellsBySupplierAndUserQuery(userId)
