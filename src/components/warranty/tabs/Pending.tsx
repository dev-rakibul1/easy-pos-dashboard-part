...
import { useGetAllPendingWarrantyQuery } from '@/redux/api/warranty/warrantyApi'
...
const Pending = () => {
  ...
  // pending info
  const { isLoading, data } = useGetAllPendingWarrantyQuery(query)
  const meta = data?.meta
  const pending = data?.warranties
